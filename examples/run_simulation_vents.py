...
with supply and exhaust air vents activating after a 20 seconds to remove the smoke.
...
To run this example with Docker:
    ...
    - Run the example script: python run_simulation_vents.py
...
To run this example on your own system with FDS installed:
    ...
    - Run the example script: poetry run python run_simulation_vents.py
